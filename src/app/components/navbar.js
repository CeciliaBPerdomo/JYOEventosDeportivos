            ...
            <nav className="bg-white border-gray-200 py-2.5 dark:bg-gray-900">
                <div className="flex flex-wrap items-center justify-between max-w-screen-xl px-4 mx-auto">
                    ...
                    <div className="flex items-center lg:order-2">
                        ...
                        <Link href="" className="focus:ring-4 font-medium rounded-lg text-sm px-4 lg:px-5 py-2 lg:py-2.5 sm:mr-2 lg:mr-0 navbar_iniciar_sesion">
                            INICIAR SESIÓN
                        </Link>
                        <Link href="" className="ml-2 focus:ring-4 font-medium rounded-lg text-sm px-4 lg:px-5 py-2 lg:py-2.5 sm:mr-2 lg:mr-0 navbar_registrarse">
                            REGISTRARSE
                        </Link>
                        ...
                        <ul className="flex flex-col mt-4 font-medium lg:flex-row lg:space-x-8 lg:mt-0">
                            <li>
                                <Link href="#"
                                    ...
                                    lg:hover:text-purple-700 lg:p-0 dark:text-gray-400 lg:dark:hover:text-white 
